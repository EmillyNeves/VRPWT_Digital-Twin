...
def load_solomon(name, input_dir=os.path.join(_HERE, "..", "data", "instances", "solomon")):
...
def load_vitoria(geojson_path=os.path.join(_HERE, "..", "data", "vitoria", "vitoria_coleta_seletiva.geojson"),
...
if __name__ == "__main__":
    for m in (load_solomon("R101"), load_wcvrptw("../data/instances/wcvrptw/102_stop.txt"),
              load_vitoria()):
