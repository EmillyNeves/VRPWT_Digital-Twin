...
"""Caracteriza e compara as DUAS referências de baseline das instâncias Solomon-100.
  ...
  - ``data/reference-solutions/dinamics/``  : referência de **mínima distância** (critério DIMACS,
    o mesmo que o solver otimiza). Cada .sol traz "Route #k: ..." e uma linha "Cost".
  - ``data/reference-solutions/sintef/`` : melhor-conhecido **lexicográfico** de Solomon
...
INPUT_DIR = os.path.join(ROOT, "data", "instances", "solomon")
DINAMICS_DIR = os.path.join(ROOT, "data", "reference-solutions", "dinamics")
SINTEF_DIR = os.path.join(ROOT, "data", "reference-solutions", "sintef")
