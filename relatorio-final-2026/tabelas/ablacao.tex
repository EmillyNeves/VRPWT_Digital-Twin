% Adaptado de results/neighborhoods/ablacao.tex (gerado por ablation_table.py).
% Apenas o envelope (caption/fonte) difere; as linhas de dados sao identicas ao artefato gerado.
\begin{table}[H]
\centering\singlespacing
\begin{minipage}{\textwidth}
\caption{Ablação \emph{leave-one-out} do conjunto de vizinhanças (VND, 28 instâncias de treino): efeito de remover cada operador do kit completo, com o placar por instância e o $p$ de Wilcoxon pareado sob correção de Holm}
\label{tab:ablacao}
\centering
